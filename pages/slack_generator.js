    ...
    return (
        <div>
            ...
            <div className={classes.optionWrap}>
                ...
                <img onClick={() => {
                    setActiveImage('jordan.jpeg');
                    setActiveName('Jordan Reedie')
                }} className={`${classes.avatarOption} ${activeImage == 'jordan.jpeg' ? classes.avatarOptionSelected : ''}`} src={'/images/jordan.jpeg'} />
            </div>
            <div className={classes.optionWrap}>
